/**
 * Plain (unencrypted) sibling of /formatting.
 *
 * Visually identical to /formatting, SAME markup, SAME styles, SAME
 * content — but with every element wrapped in data-cloak-exclude so
 * the SDK skips the entire page. Nothing gets encrypted, no search
 * highlights ever draw here, no custom font is applied. This is what
 * the article looks like on a normal unprotected website.
 *
        ...
        <>
            ...
            <header className="mb-10 border-b border-zinc-200 pb-8 dark:border-zinc-800">
                ...
                <p className="mt-4 text-lg leading-relaxed text-zinc-600 dark:text-zinc-400">
                    This page has identical markup to{" "}
                    <a href="/formatting" className="text-indigo-600 underline dark:text-indigo-400">
                        /formatting
                    </a>
                    , but the entire subtree is wrapped in{" "}
                    <code>data-cloak-exclude</code> so the SDK never
                    touches it. It&apos;s the reference for what the
                    article should look like without any encryption,
                    search overlay, or custom font applied.
                </p>
...
greet("there");`}
                ...
                <p className="mt-10 text-sm text-zinc-500">
                    ...
                    . Any visual difference between the two pages is
                    introduced by Cloak.
                </p>
            </article>
        </main>
